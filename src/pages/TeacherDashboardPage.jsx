    ...
    const TeacherDashboardPage = () => {
      const { t } = useTranslation();
        ...
        const mockLogs = [
          { name: 'Ahmed Amr', action: 'has contacted you', time: '6:00 AM' },
          { name: 'Sara Tarek', action: 'viewed your profile', time: '7:30 AM' },
          ...
          { name: 'Rania Magdy', action: 'left a review', time: '5:45 PM' },
          ...
          { name: 'Aya Khalil', action: 'requested a refund', time: '10:00 PM' },
        ...
        return (
              ...
              <CardContent className="h-[450px] flex items-center justify-center bg-muted/30 rounded-md border-2 border-dashed border-border/50">
                <div className="text-center text-muted-foreground p-6"  style={{ direction: 'ltr' }}>
                <BasicLineChart
                  uData={[11, 12, 13, 24, 5, 6, 17]}
                  secondaryData={[20, 33, 41, 50, 63, 71, 89]}
              ...
              <CardDescription>{t('recentInteractions')}</CardDescription>
                ...
                <CardContent className="flex-1 overflow-y-auto px-4 pb-4 max-h-[400px] scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent">
              {mockLogs.length === 0 ? (
