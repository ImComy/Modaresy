      ...
      <div className="w-full max-w-6xl flex justify-center items-center">
        ...
        <section className="space-y-6">
          <motion.div
            ...
            className="rounded-2xl p-8 shadow-lg bg-gradient-to-br from-[color:hsl(var(--primary))/0.06] to-[color:hsl(var(--primary))/0.12] border border-[color:hsl(var(--border))/0.06]"
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-[color:hsl(var(--primary))/0.12] text-[color:hsl(var(--primary))] shadow-inner">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="rounded-xl p-3 bg-[color:hsl(var(--popover))] border shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-[color:hsl(var(--primary))/0.08]">
...
function FeatureCard({ icon, title, desc }) {
  return (
    <div className="rounded-xl p-3 bg-[color:hsl(var(--popover))] border shadow-sm flex items-start gap-3">
      <div className="p-2 rounded-lg bg-[color:hsl(var(--primary))/0.08] text-[color:hsl(var(--primary))] flex items-center justify-center">{icon}</div>
      <div>
        <div className="font-semibold text-sm text-[color:hsl(var(--foreground))]">{title}</div>
        <div className="text-xs text-[color:hsl(var(--muted-foreground))] mt-1">{desc}</div>
      </div>
    </div>
  );
}
    ...
    <div className="p-3 rounded-xl bg-white/80 border shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="text-sm font-semibold text-[color:hsl(var(--foreground))] truncate">{title}</div>
          <div className="text-xs text-[color:hsl(var(--muted-foreground))] mt-1 truncate">{excerpt}</div>
        </div>
