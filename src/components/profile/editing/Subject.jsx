...
const SubjectPricingInfoEdit = ({
  ...
  const handleOfferChange = (field, value) => {
    const updated = { ...offer, [field]: field === "percentage" ? Number(value) || 0 : value };
    setOffer(updated);
  ...
  const addAdditionalPricing = () => {
    if (newAdditionalPricing.name && newAdditionalPricing.price) {
      const updated = [
        ...additionalPricing,
        { ...newAdditionalPricing, price: Number(newAdditionalPricing.price) || 0, period: newAdditionalPricing.period || "2" },
      ];
      setAdditionalPricing(updated);
      handleFieldChange("additionalPricing", updated);
  ...
  return (
    <Card className="w-full border-primary/30 shadow-lg rounded-xl relative overflow-visible bg-gradient-to-br from-primary/5 to-primary/10">
      ...
      <CardContent className="p-6 space-y-6">
        {/* Subject Bio */}
        <div className="space-y-3 p-5 bg-muted/20 rounded-xl border border-primary/30 transition-all hover:shadow-md">
        ...
        {/* Offer Section */}
        <div className="p-5 border border-green-300 bg-lime-200/30 rounded-xl space-y-4 transition-all hover:shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input
              ...
              className="border-primary/30 focus:border-primary focus:ring-primary/20 transition-colors shadow-sm"
            />
            <Select
              value={offer.for}
              onValueChange={(value) => handleOfferChange("for", value)}
            >
              <SelectTrigger className="border-primary/30 focus:border-primary focus:ring-primary/20 transition-colors shadow-sm">
          ...
          <Textarea
            ...
            className="w-full min-h-[100px] border-primary/30 focus:border-primary focus:ring-primary/20 transition-colors shadow-sm"
          />
        </div>

        {/* Payment Info */}
        <div className="p-5 bg-muted/20 rounded-xl border border-primary/30 space-y-4 transition-all hover:shadow-md">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              >
                <SelectTrigger className="w-full max-w-xs border-primary/30 focus:border-primary focus:ring-primary/20 transition-colors shadow-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {additionalPricing.map((item, index) => (
                <div
                  key={index}
                  className="relative flex flex-col gap-4 bg-card rounded-xl border border-primary/30 shadow-sm p-5 hover:shadow-lg hover:border-primary transition-all"
                >
              ...
              <div className="relative flex flex-col gap-4 bg-card rounded-xl border border-primary/30 shadow-sm p-5 hover:shadow-lg hover:border-primary transition-all">
                <div className="absolute top-4 left-0 h-10 w-1.5 bg-accent rounded-r" />
                <div className="pl-3 space-y-3">
                  <Input
