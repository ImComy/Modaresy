    ...
    const SelectTrigger = React.forwardRef(({ className, children, error, ...props }, ref) => ( // Added error prop
      <SelectPrimitive.Trigger
        ...
        className={cn(
          ...
          error && 'border-destructive focus:ring-destructive', // Add error styling
          className
        )}
        {...props}
      >
