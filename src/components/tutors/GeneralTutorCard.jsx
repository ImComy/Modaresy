...
import { MapPin, Heart, GraduationCap, ChevronDown, Calendar } from 'lucide-react';
          ...
          <CardContent className="flex-1 pt-12 pb-4 px-4 flex flex-col justify-between">
            ...
            <div className="text-center space-y-1">
              ...
              <div className="flex items-center justify-center gap-3 text-muted-foreground text-sm">
                ...
                <div className="flex items-center gap-1">
                  <MapPin size={14} />
                  <span>{tutor?.location || t('locationNotSpecified')}</span>
                </div>
              </div>
            </div>
            ...
            {Object.entries(grouped).map(([type, subjects]) => {
              const isOpen = openTypes[type] ?? Object.keys(grouped).length === 1;
